...
return [
    ...
    // 通報
    'report.title' => '通報',
    'report.intro' => '不適切な投稿・スレッドを運営に通報します。内容は運営のみが確認します。',
    'report.reason' => '理由',
    'report.reason.spam' => 'スパム・宣伝',
    'report.reason.abuse' => '誹謗中傷・嫌がらせ',
    'report.reason.illegal' => '違法・権利侵害',
    'report.reason.other' => 'その他',
    'report.detail' => '詳細（任意）',
    'report.detail_ph' => '補足があれば記入してください',
    'report.submit' => '通報する',
    'report.done.title' => '通報を受け付けました',
    'report.done.body' => 'ご協力ありがとうございます。運営が確認し、必要に応じて対応します。',
    'show.report' => '通報',
    ...
    // トップ（home）
    'home.tagline' => '面白い投稿を見抜いて株を“売買”する。早く仕込んで高く売る、目利き勝負の匿名掲示板バトル。',
    'home.what.title' => 'どんなサイト？',
    'home.what.p1' => 'ここは普通の掲示板ではありません。誰でも匿名でスレ立て・レスができ、登録ユーザーは「面白い」と思ったレスに<strong>投資して株を売買できます</strong>。',
    'home.what.p2' => '後から投資が集まるほどそのレスの<strong>株価が上がる</strong>ので、まだ誰も気づいていない名レスを<strong>早く仕込み、値上がりしたら売って利確（現金化）</strong>できる——「目利き」が主役のゲームです。',
    ...
    'home.rules.r2' => '<strong>朽ちる</strong>：スレもレスもHPを持ち、放置すると時間で減って消滅（dead）。dead の株は売ってもほぼ0＝朽ちる前に売り抜けるのが肝。',
    ...
    'home.rules.r5' => '<strong>売って現金化</strong>：いつでも保有株を売れる。受け取り額は「いま売ったら得られる額」＝投資が集まった分の持ち分×鮮度(HP)。朽ちるほど目減りする。',
    ...
    'flash.sell' => '{shares}株を売却 → {payout} を受け取りました。',
    'flash.sell_failed' => '売却できませんでした: {msg}',
    ...
    'err.account_suspended' => 'このアカウントは利用停止中です',
